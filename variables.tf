variable "create_database" {
  description = "Whether to create the CloudSQL database"
  type        = bool
  default     = true
}
...
variable "create_additional_databases" {
  description = "Wether A list of databases to be created in your cluster"
  type        = bool
  default     = true
}
...
variable "internal_database_ip" {
  description = "Whether to create private IP allocation for Cloud SQL"
  type        = bool
  default     = true
}

variable "create_service_networking_connection" {
  description = "Whether to create service networking connection"
  type        = bool
  default     = true
}

variable "private_ip_prefix_length" {
  description = "Prefix length for private IP allocation"
  type        = number
  default     = 20
}

variable "private_ip_address" {
  description = "Private IP address for allocation"
  type        = string
  default     = null
}